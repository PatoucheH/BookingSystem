...
namespace BookingSystem.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (_ApplicationUserManager.Options.SignIn.RequireConfirmedAccount)
                    {
        ...
        {
            if (!_ApplicationUserManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a ApplicationUser store with email support.");
            }
            return (IUserEmailStore<ApplicationUser>)_ApplicationUserStore;
        }
    }
}
